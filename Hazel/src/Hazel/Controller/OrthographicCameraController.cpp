...
namespace Hazel
{
    ...
    void OrthographicCameraController::OnUpdate(Timestep timestep)
    {
        ...
        if (m_Rotation)
            {
                if (Input::IsKeyPressed(HZ_KEY_Q)) m_CameraRotation += m_CameraRotationSpeed * timestep;
                if (Input::IsKeyPressed(HZ_KEY_E)) m_CameraRotation -= m_CameraRotationSpeed * timestep;
